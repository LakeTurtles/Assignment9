...
import static com.ultima.Senorial.domain.ThreadColor.*;
import static com.ultima.Senorial.domain.ThreadColor.ANSI_YELLOW;
...
public class Recipe {
	...
	public String toString() {
		return getRandomVal() + "Recipe [cookingMinutes=" + cookingMinutes + ", dairyFree=" + dairyFree + ", glutenFree=" + glutenFree
	...
	private static String getRandomVal(){
		String[] data = {ANSI_BLUE,  ANSI_PURPLE, ANSI_CYAN, ANSI_YELLOW};
